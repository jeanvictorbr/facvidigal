// src/components/buttons/sales_action_calculate.js
const { ButtonInteraction, ActionRowBuilder, ButtonBuilder, ButtonStyle, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, EmbedBuilder, MessageFlags } = require('discord.js');
const prisma = require('../../prisma/client');

module.exports = {
    customId: 'sales_action_calculate',
    async execute(interaction) {
        // Cria uma NOVA resposta efêmera para o usuário
        ...
        if (categories.length === 0) {
            return interaction.editReply({ content: 'O arsenal está vazio. A liderança precisa catalogar os itens primeiro.' });
        }
